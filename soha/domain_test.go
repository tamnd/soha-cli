...
// HTTP behaviour is covered in soha_test.go.
...
func TestDomainInfo(t *testing.T) {
	...
	if info.Identity.Binary != "soha" {
		t.Errorf("Identity.Binary = %q, want soha", info.Identity.Binary)
	}
}
...
func TestHostWiring(t *testing.T) {
	...
	if want := "soha://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("soha", "about")
	if err != nil || got.String() != "soha://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want soha://page/about", got.String(), err)
	}
}
